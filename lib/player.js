window.jwplayer = function (t) {
   ...
   var r = n(29),
      ...
      u = function () {
         var t = "//ssl.p.jwpcdn.com/player/v/8.17.1/";
   ...
   var r = "8.17.1+commercial_v8-17-1.420.commercial.6107038.hlsjs..hlsjsprogressive.dd9ffc5.jwplayer.8fb2579.dai.07e1a38.freewheel.af0c077.googima.0c2b122.googimanvmp.6873d1e.headerbidding.179206e.vast.8fedf3e.analytics.231d1d1.gapro.141397a"
}, function (t, e, n) {
   "use strict";
   var r = n(0),
      i = n(18),
   ...
   function m(t, e) {
      var n = "file:" === window.location.protocol ? "https:" : "",
         r = {
            bidding: "//ssl.p.jwpcdn.com/player/v/8.17.1/bidding.js",
            jwpsrv: "//ssl.p.jwpcdn.com/player/v/8.17.1/jwpsrv.js",
            dai: "//ssl.p.jwpcdn.com/player/plugins/dai/v/0.4.13/dai.js",
            vast: "//ssl.p.jwpcdn.com/player/plugins/vast/v/8.8.1/vast.js",
            googima: e ? "//ssl.p.jwpcdn.com/player/v/8.17.1/googimanvmp.js" : "//ssl.p.jwpcdn.com/player/plugins/googima/v/8.8.1/googima.js",
   ...
   function T(t) {
      return S || (S = function (t) {
         ...
         if (e && r && i) return o = n.e(7).then(function (t) {
            n(148);
            var e = n(71).default;
            return x.a.controls = n(70).default, Object(C.a)(n(152).default), e
   ...
   function L(t) {
      ...
      return new Promise((function (n, r) {
         ...
         var o = new F.a;
         o.on(_.eb, (function (e) {
            var r = e.playlist;
            delete e.playlist, N(t, r, e), n()
         })), o.on(_.w, (function (e) {
            N(t, [], {}), r(Object(P.B)(e, P.w))
         })), o.load(e)
      }))
   }
   ...
   function z(t) {
      return H(t) ? Promise.resolve() : L(t).then((function () {
         if (t.get("drm") || Object(D.b)(t.get("playlist"))) return Object(D.d)(t.get("edition"))
      })).then((function () {
   ...
   function V(t) {
      ...
      if (n && n.code === s.a) {
         var r = e.pid,
            i = e.ph,
            o = new s.b(e.key);
         if (i > 0 && i < 4 && r && o.duration() > -7776e6) return new I.a("//content.jwplatform.com/libraries/" + r + ".js").load().then((function () {
   ...
   var Q = function (t) {
         ...
         if ("string" == typeof e && ! function (t) {
            ...
            return new I.a(e, !0).load().catch((function (t) {
               return t
            }))
         }
         return Promise.resolve()
      ...
      W = function (t) {
         var e = t.attributes,
            ...
            o = e.intl,
            u = Object(M.c)(i, o, n);
         return !Object(M.h)(n) || Object(M.f)(u) ? Promise.resolve() : new Promise((function (i) {
            return Object(M.i)(r, n).then((function (n) {
               var r = n.response;
               if (!R(t)) {
                  if (!r) throw new P.t(null, P.h);
                  e.localization = Object(M.a)(r, u), i()
               }
            })).catch((function (t) {
   ...
   var X = function (t) {
         ...
         this.start = function (n) {
            var r = Object(A.a)(t, n),
               i = Promise.all([T(t), r, z(t), q(t, n), Q(t), W(t)]),
   ...
   var $ = function () {
         ...
         return e.getAllItems = function () {
            ...
            return this.items.reduce((function (e, n) {
               ...
               return r && (e[n] = "captions" !== n ? Object(J.serialize)(r) : JSON.parse(r)), e
            }), {})
         }, e.track = function (t) {
            var e = this;
   ...
   var ut = function (t) {
      this._events = {}, this.modelShim = new G.a, this.modelShim._qoeItem = new Y.a, this.mediaShim = {}, this.setup = new X(this.modelShim), this.currentContainer = this.originalContainer = t, this.apiQueue = new i.a(this, ["load", "play", "pause", "seek", "stop", "playlistItem", "playlistNext", "playlistPrev", "next", "preload", "setConfig", "setCurrentAudioTrack", "setCurrentCaptions", "setCurrentQuality", "setFullscreen", "addButton", "removeButton", "castToggle", "setMute", "setVolume", "setPlaybackRate", "addCues", "setCues", "setPlaylistItem", "resize", "setCaptions", "setControls"], (function () {
         return !0
      }))
   };
   ...
   Object(r.j)(ut.prototype, {
      ...
      init: function (t, e) {
         var n = this,
            i = this.modelShim,
            o = new $("jwplayer", ["volume", "mute", "captionLabel", "captions", "bandwidthEstimate", "bitrateSelection", "qualityLabel", "enableShortcuts"]),
            u = o && o.getAllItems();
         i.attributes = i.attributes || {}, Object(r.j)(this.mediaShim, tt.a);
         var a = t,
            c = y(Object(r.j)({}, t), u);
         c.id = e.id, c.setupConfig = a, Object(r.j)(i.attributes, c, tt.b), i.getProviders = function () {
            return new U.a(c)
         }, i.setProvider = function () {};
         var s = Object(rt.b)();
         i.get("backgroundLoading") || (s = Object(it.a)(s.getPrimedElement(), s));
         var l = new ot.a(Object(ot.b)(this.originalContainer)).once("gesture", (function () {
            s.prime(), n.preload(), l.destroy()
         }));
         return i.on("change:errorEvent", at), this.setup.start(e).then((function (t) {
            var u = t.core;
            if (!u) throw Object(P.B)(null, P.y);
            if (n.setup) {
               n.on(_.wb, ct), t.warnings.forEach((function (t) {
                  n.trigger(_.wb, t)
               }));
               ...
               var l = n._model;
               return i.off("change:errorEvent", at), l.on("change:errorEvent", at), o.track(l), n.updatePlaylist(l.get("playlist"), l.get("feedData")).catch((function (t) {
            ...
            n.setup && function (t, e, n) {
               Promise.resolve().then((function () {
                  ...
                  if (!o) {
                     var u = Object(nt.a)(t, r);
                     nt.a.cloneIcon && u.querySelector(".jw-icon").appendChild(nt.a.cloneIcon("error")), st(t, u)
                  }
                  i.set("errorEvent", r), i.set("state", _.mb), t.trigger(_.jb, r), o && e.remove()
               }))
            }(n, e, t)
         }))
      },
      playerDestroy: function () {
         this.apiQueue && this.apiQueue.destroy(), this.setup && this.setup.destroy(), this.currentContainer !== this.originalContainer && st(this, this.originalContainer), this.off(), this._events = this._model = this.modelShim = this.apiQueue = this.setup = null
      },
      getContainer: function () {
...
var jwDefaults = {
   ...
   "displaytitle": true,
   "height": 260,
   "key": "Lsz+JtohurMHer6MN62owImrKVg98FiCdollsh80h2E=",
   "mute": false,
